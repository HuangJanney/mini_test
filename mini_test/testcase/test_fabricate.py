...
if __name__ == '__main__':
    ...
    # 定义报告属性
    result.report(description='配方测试', filename=filename, report_dir=FileUtil.get_report_path())
